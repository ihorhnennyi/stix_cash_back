...
/**
 * DTO для банковских реквизитов (Wire Transfer)
 */
export class WireTransferDto {
  ...
  @ApiPropertyOptional({
    ...
    description: "Billing address for the bank account",
  })
  @IsOptional()
  @IsString()
  address?: string;
...
/**
 * DTO для перевода через Zelle
 */
export class ZelleTransferDto {
  @ApiPropertyOptional({
    example: "Jane Doe",
    description: "Full name of the Zelle recipient",
  })
  @IsOptional()
  @IsString()
